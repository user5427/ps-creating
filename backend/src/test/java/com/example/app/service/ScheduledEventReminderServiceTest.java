...
class ScheduledEventReminderServiceTest {
        ...
        @BeforeEach
        void setUp() {
                attendee = new User(UUID.randomUUID(), "attendee@example.com", "John", "Doe", "+15555550123",
                                Role.ATTENDEE);
        ...
        /**
         * Test that multiple tickets for the same or different events all get
         * reminders.
         */
        @Test
        ...
        void testSkipsSmsWhenPhoneNumberMissing() {
                User attendeeWithoutPhone = new User(UUID.randomUUID(), "nophone@example.com", "John", "Doe", null,
                                Role.ATTENDEE);
