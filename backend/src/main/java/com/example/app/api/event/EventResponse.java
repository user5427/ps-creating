...
public record EventResponse(
    ...
    /**
     * Named builder for {@link EventResponse}. Lets callers construct the record
     * by field name instead of an 18-argument positional constructor, so adding
     * or reordering record components doesn't silently shuffle call-site values.
     * Hand-written because Lombok's {@code @Builder} on records isn't compatible
     * with the current JDK / Lombok combo on our build toolchain.
     */
