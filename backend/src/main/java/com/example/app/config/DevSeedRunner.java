...
public class DevSeedRunner implements CommandLineRunner {
    ...
    private void seedEvents() {
        ...
        List<Event> samples = List.of(
                buildEvent("Vilnius Jazz Night", "A curated evening of live jazz with local and international acts.",
                ...
                buildEvent("Frontend Architecture Meetup", "Lightning talks from React, Svelte, and Qwik engineers.",
                ...
                buildEvent("Techno Open Air", "Outdoor techno festival with six international headliners.",
                        "Music", "Vingis Park",
                ...
                buildEvent("Startup Pitch Day", "Ten early-stage startups pitch to angel investors and the public.",
                ...
                buildEvent("Stand-Up Comedy Open Mic", "Five minutes, five laughs — or you owe the bar a round.",
                ...
                buildEvent("Opera at the Palace", "An evening of arias from Verdi, Puccini, and Wagner.",
